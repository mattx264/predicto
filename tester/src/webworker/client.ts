...
export class Client {
  ...
  constructor(
    ...
    this.http = http ? http : (null as any);
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as ArticleDTO);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
  ...
  protected processGetTournamentById(
    response: Response,
  ): Promise<GameListDto[]> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as GameListDto);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
  ...
  protected processGameByTournament(
    response: Response,
  ): Promise<TeamListDto[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  getById(
    ...
    if (tournamentId === undefined || tournamentId === null)
      throw new globalThis.Error(
        "The parameter 'tournamentId' must be defined.",
      );
    url_ = url_.replace(
      "{tournamentId}",
  ...
  protected processGetTournamentById2(
    response: Response,
  ): Promise<GameListDto[]> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as RoomDTO);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
  ...
  protected processGetGamesBetsAndPoints(
    response: Response,
  ): Promise<RoomGameDto[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  sentInvitationEmail(
    ...
    let url_ =
      this.baseUrl + "/api/TesterHelper/{gameid}/sent-invitation-email?";
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as GroupDto[]);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
