    ...
    public class SeedData
    {
        public Action<DbContext, bool> Data()
        {
            return (context, someFlag) =>
            {
                ...
                {
                    context.Add(new UserEntity { Email = "admin@predicto.gg", Name = "admin", Lang = "pl", Password = "" });
                    context.Add(new UserEntity {Email="test@test",Name="test11",Lang="pl",Password="" });
                    context.Add(new UserEntity { Email = "test2@test", Name = "test22", Lang = "pl", Password = "" });
                    context.Add(new UserEntity { Email = "test3@test", Name = "test33", Lang = "pl", Password = "" });
        ...
        private void SeedArticles(DbContext context)
        {
            context.Add(new ArticleEntity
            {
                ...
                CreatedDate = new DateTime(2025, 10, 14),
